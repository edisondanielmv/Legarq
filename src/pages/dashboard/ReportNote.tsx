...
export default function ReportNote() {
  ...
  const filteredProcedures = procedures.filter(p => {
    ...
    const statusMatch = statusFilter === 'Todos' || statusVal === statusFilter;
        ...
        <div className="hidden lg:flex lg:col-span-4 bg-white p-4.5 rounded-[20px] border border-gray-100 shadow-sm flex-col h-[calc(100vh-280px)] min-h-[500px]">
          <div className="mb-4">
            ...
            <select
              ...
              className="w-full h-10 px-3 bg-gray-50 border border-gray-200 rounded-xl text-[10px] font-black tracking-widest uppercase text-gray-600 focus:outline-none focus:ring-1 focus:ring-red-500/50 focus:border-red-500 transition-all text-center"
            >
          ...
          <div className="bg-white p-3.5 sm:p-5 rounded-[20px] border border-gray-100 shadow-sm">
            ...
            {selectedProcedure ? (
              <div className="space-y-3">
                ...
                <div className="p-3 bg-gray-50/50 border border-gray-100 rounded-xl flex flex-col sm:flex-row sm:items-start justify-between gap-3">
